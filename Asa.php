...
$res = mysqli_query($link,"select * from Client C,user U where C.Client_ID=U.ID and ID = '$id'")
		or die("Failed to query database".mysqli_error());
...
$res1 = mysqli_query($link,"select * from Client where First_Name = '$name'")
		or die("Failed to query database".mysqli_error());
...
<div id="cpe" style="display:none;"class="modal">
  ...
  <form method = "POST" action="cp.php">
    ...
    <div class="container">
	<input type="text" value=<?php echo $r?> name="nm"  >
...
<div class="html_content" style="padding-top:10px;"><p style="margin:0.36em 0em 0.36em 3.0em;text-align:center;;"><span style="font-family:'Georgia','Arial';font-size:3.286em;color:black;">Welcome Client</span><span style="font-family:'Georgia','Arial';font-size:3.286em;color:rgba(0,203,203,1);"> <?php echo $name;?>!!</span></p><p style="margin:0.36em 0em 0.36em 1.43em;text-align:Center;"><br style="font-family:'Ubuntu','Arial';font-size:1.143em;color:rgba(255,101,1,1);" /></p><p style="margin:0.36em 0em 0.36em 1.43em;text-align:Center;"><span style="font-family:'Ubuntu','Arial';font-size:1.143em;color:rgba(255,255,255,0.8);"></span></p></div>
...
<div class="imgcontainer">
		<span style ="font-family:Times New Roman;color:black;font-size:28px">Client ID:<?php echo $id;?></span>
        <span onclick="document.getElementById('edetails1').style.display='none'" class="close" title="Close Modal">&times;</span>
    </div>
	<div class="container">
	    <label><b>Client Id: <?php echo $id;?></b></label>
	  ...
	  <label><b>Address:<?php echo $Add;?> </b></label></br>
